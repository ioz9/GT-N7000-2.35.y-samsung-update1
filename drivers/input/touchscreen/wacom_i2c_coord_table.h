...
short *tableX[MAX_HAND][MAX_ROTATION]= {{CodTblX_PLeft_44, CodTblX_CCW_LLeft_44, CodTblX_CW_LRight_44, CodTblX_PRight_44},
										{CodTblX_PRight_44, CodTblX_PLeft_44, CodTblX_CCW_LLeft_44, CodTblX_CW_LRight_44}};

short *tableY[MAX_HAND][MAX_ROTATION]= {{CodTblY_PLeft_44, CodTblY_CCW_LLeft_44, CodTblY_CW_LRight_44, CodTblY_PRight_44},
										{CodTblY_PRight_44, CodTblY_PLeft_44, CodTblY_CCW_LLeft_44, CodTblY_CW_LRight_44}};
...
short tilt_offsetX[MAX_HAND][MAX_ROTATION]= {{120, 110, -85, -110,},{-120, 120, 60, -130,}};
short tilt_offsetY[MAX_HAND][MAX_ROTATION]={{-110, 110, 110, -150,},{-130, -110, 130, 70,}};
